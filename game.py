...
if __name__ == "__main__":
    bot_difficulty = int(input("Choose bot difficulty level (0-7): "))
    if bot_difficulty < 0 or bot_difficulty > 7:
        print("Invalid difficulty level! Please choose a level between 0 and 7.")
    else:
